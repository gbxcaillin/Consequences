...
const BUILD = 60;   // shown on the title screen; bump with the service worker
...
const SKY_MP4 = 'assets/scenes/opening-sky6.mp4';
const SKY_WEBM = 'assets/scenes/opening-sky6.webm';
  ...
  if (state.phase === 'title') {
    ...
    app.innerHTML = `
      <div class="crawl-screen">
        <video class="crawl-bg" autoplay muted playsinline preload="auto" poster="assets/scenes/opening-sky.webp"><source src="assets/scenes/opening-sky6.webm" type="video/webm"><source src="assets/scenes/opening-sky6.mp4" type="video/mp4"></video>
        <div class="crawl-vp">
