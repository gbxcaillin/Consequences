...
const BUILD = 55;   // shown on the title screen; bump with the service worker
...
const SKY_MP4 = 'assets/scenes/opening-sky2.mp4';
const SKY_WEBM = 'assets/scenes/opening-sky2.webm';
  ...
  if (state.phase === 'title') {
    ...
    app.innerHTML = `
      <div class="crawl-screen">
        <video class="crawl-bg" autoplay muted playsinline preload="auto" poster="assets/scenes/opening-sky.webp"><source src="assets/scenes/opening-sky2.mp4" type="video/mp4"><source src="assets/scenes/opening-sky2.webm" type="video/webm"></video>
        <div class="crawl-vp">
